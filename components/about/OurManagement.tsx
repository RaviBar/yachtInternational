  ...
  return (
    <section className="max-w-6xl mx-auto px-4 py-20 bg-white">
      <div className="text-center font-oswald mb-20">
        <h2 className="text-[#0057EB] font-semibold tracking-wide uppercase mb-6">MEET OUR TEAM</h2>
        <h3 className="text-[48px] text-[#000000] font-oswald font-bold tracking-[0.01em] leading-relaxed text-[#212B36]">
          Our Management
        </h3>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
        <div className="border border-gray-200 p-8 flex flex-col items-center text-center">
      ...
      <div className="flex flex-wrap justify-center gap-8 mb-12">
        <div className="w-full md:w-[calc(33.333%-1rem)] border border-gray-200 p-8 flex flex-col items-center text-center">
        ...
        <div className="w-full md:w-[calc(33.333%-1rem)] border border-gray-200 pt-8 flex flex-col items-center text-center">
